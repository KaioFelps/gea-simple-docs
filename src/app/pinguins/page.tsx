...
export default function Pinguins() {
  const catalogItems = [
    ...
    },
    {
      ...
      price: 100,
      title: "Azul escuro",
      furniName: "Tanzanite Baby Penguin",
    },
    {
      image: citrine.src,
      price: 100,
